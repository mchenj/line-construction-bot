...
def _help_text():
    return (
        "📖 คู่มือใช้งาน LINE Construction Bot\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "\n"
        "1️⃣ บันทึกรายงานประจำวัน\n"
        "──────────────\n"
        "พิมพ์ข้อความตามรูปแบบ → ส่งรูปต่อภายใน 10 นาที\n"
        "\n"
        "📝 ตัวอย่าง:\n"
        "วันที่ 27 เมษายน 2569 อากาศแจ่มใส\n"
        "1. ผรจ.หล่อบ่อพักขนาด 1,500 มม.\n"
        "2. ผรจ.ตัดหัวเสาเข็มงานเขื่อนแบบที่ 1\n"
        "วิศวกร 2 คน หัวหน้าคนงาน 3 คน\n"
        "กรรมกร 7 คน รวม 12 คน\n"
        "รถแบ็คโฮ 1 คัน\n"
        "+92.50\n"
        "[ส่งรูปต่อ]\n"
        "\n"
        "💡 ใส่ 1. 2. 3. นำหน้ากิจกรรม\n"
        "\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "\n"
        "2️⃣ เพิ่มข้อมูลย้อนหลัง (ผ่าน 1+ ชม.)\n"
        "──────────────\n"
        "/add 27/04      → เพิ่มกิจกรรม/รูปวันที่ 27 เม.ย.\n"
        "/add 27/04/69   → ระบุปีได้\n"
        "/add cancel     → ยกเลิก\n"
        "(หลังสั่ง /add ส่งข้อความ/รูปได้ใน 30 นาที)\n"
        "\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "\n"
        "3️⃣ บันทึกระดับน้ำเฉยๆ\n"
        "──────────────\n"
        "+92.70          → ระดับน้ำ +92.70 ม.\n"
        "-2.30           → ระดับน้ำติดลบ\n"
        "\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "\n"
        ...
        "━━━━━━━━━━━━━━━━━━\n"
        "\n"
        "5️⃣ อัปโหลดข้อมูล Excel\n"
        "──────────────\n"
        "/upload_plan    → แผนงานก่อสร้าง .xlsx\n"
        "/upload_cm      → บุคลากร CM .xlsx\n"
        "(สั่งคำสั่ง แล้วส่งไฟล์ Excel ใน 10 นาที\n"
        " ไฟล์เก่าจะถูก backup อัตโนมัติ)\n"
        "\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "\n"
        "6️⃣ ลบข้อมูล\n"
        ...
        "/delete 22/04   → ลบวันที่ 22 เม.ย.\n"
        "\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "\n"
        "ℹ️ พิมพ์ /help เพื่อดูเมนูนี้อีกครั้ง"
    )
